                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(text:"${box.read('number')}",style: TextStyle(
                    ...
                    Container(
                      ...
                      padding:
                       EdgeInsets.only(bottom: 0, top: 0, left: SizeConfig.screenHeight!*0.02 , right: SizeConfig.screenWidth!*0.27),
                      child: PinPut(
                        obscureText: ('\u{20B9}'),
                        fieldsCount: 4,
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.phone_in_talk,color: GlobalColors.apptheme,),
                          SizedBox(
