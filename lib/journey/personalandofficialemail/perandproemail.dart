...
class  pandpf extends StatefulWidget {
  const pandpf({Key? key}) : super(key: key);

  @override
  State<pandpf> createState() => _pandpfState();
}

class _pandpfState extends State<pandpf> {
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(8),
                            borderSide:  BorderSide(color: GlobalColors.subtextandborder)),
                        hintText: "Enter your professional e-mail",
                        // hintStyle: const TextStyle(color: Colors.black)
                        // prefixIcon: const Icon(Icons.lock),
                        // suffixIcon: IconButton(
                        //   icon: hidePassword
