...
class sliderbottom2 extends StatefulWidget {
  // final  PageController _pageController ;
  // onboarding1(this._pageController);


  @override
  _sliderbottom2State createState() => _sliderbottom2State();
}

class _sliderbottom2State extends State<sliderbottom2> {
        ...
        children: [
          ElevatedButton(
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => workdesignation()),
              );
