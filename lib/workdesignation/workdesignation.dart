                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child:   ElevatedButton(
                          ...
                          child: const Text(
                            "Read more",
                            style: TextStyle(color: Color(0xff0F9AFF)  ,fontWeight: FontWeight.w200 ),
                          ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        //   },
                        // ),
                        CircleAvatar(child: Icon(Icons.camera,color: Color(0xff0F9AFF),size: SizeConfig.screenHeight!*0.045,),backgroundColor: Color(0xff0F9AFF).withOpacity(0.3), radius: SizeConfig.screenHeight!*0.028,),
                        Padding(
