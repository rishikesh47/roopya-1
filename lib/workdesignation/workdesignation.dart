...
import '../reusable_widgets/title_subtitle_reusable.dart';
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  Text(Constants.personalLoanText,
                      style: TextStyle(
              ...
              const TitleSubtitleReusable(
                titleText: '${Constants.userworkEmployeeStatus}',
                subTitleText: "${Constants.userworkEmployeeSubStatus}",
              ),
              SizedBox(
              ...
              Container(
                child: Padding(
                  padding:
                      EdgeInsets.only(left: SizeConfig.screenHeight! * 0.025),
                  child: Column(
                    children: [
                      // Text("dlkw")
                      ListTileReusable(
